          ...
          settings = {
            Lua = {
              ...
              diagnostics = {
                ...
                globals = { "ls", "t", "s", "sn", "i", "f", "d", "fmt", "fmta", "rep" }
              },
            },
          },
        },
...
--This moves around the keyboard to be colemak; to keep keymap things right we
--want to do this at the right time?
...
---- Snippet Config ----
-- First we want to load the snippets I have saved locally
--require('luasnip.loaders.from_lua').load({ paths = '~/.config/nvim/luasnippets/' })
-- Then we want to soure the helper functions we write:
require('luasnip-helper-functions')
...
--maybe we want to load the new keymap as the very first thing?
